...
def train(args):
    ...
    freeze_layer_number = len(model.layers) - 2
    for i in range(freeze_layer_number):
    ...
    print('Train on {} samples with val split {}, with batch size {}.'.format(len(x_train), args.val_split, args.batch_size))
