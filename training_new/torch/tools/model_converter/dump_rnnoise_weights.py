...
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'weight-exchange'))
...
if __name__ == "__main__":
    ...
    model = torch.load(args.weightfile, map_location=torch.device('cpu'), weights_only=False).float()
    model.eval()
