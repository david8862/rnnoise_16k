...
def onnx_convert(keras_model_file, output_file, op_set, batch_size, window_size, inputs_as_nchw):
    import tf2onnx
...
def main():
    ...
    if args.with_savedmodel:
        ...
        onnx_convert(args.keras_model_file, args.output_file, args.op_set, args.batch_size, args.window_size, args.inputs_as_nchw)
